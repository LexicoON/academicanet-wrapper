...
/* NOTA: el styling de la pantalla de Login vive ahora en
   academica_login_cleanup_v9.0-alpha.js (inyectado solo cuando aplica).
   Asi evitamos que el bloque :has(.contact__form) contamine
   accidentalmente otras paginas con selectores parecidos. */
